...
// Self-hosted feed via Supabase cache — no third-party view limits
const INSTAGRAM_HANDLE = 'northvsouthpadel';
const INSTAGRAM_PROFILE_URL = 'https://www.instagram.com/northvsouthpadel/';
...
// InstagramFeedWidget removed — replaced by <InstagramFeed /> component
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="w-full mb-10 md:mb-16">
              <InstagramFeed handle={INSTAGRAM_HANDLE} limit={9} />
            </div>
