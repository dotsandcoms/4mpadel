...
import { Calendar as CalendarIcon, MapPin, Clock, Users, ArrowRight, GitBranch } from 'lucide-react';
                    ...
                    <div className="flex flex-row gap-4 items-center flex-1 w-full">
                        ...
                        <div className="flex-1 min-w-0 py-1">
                            <div className="flex flex-wrap gap-2 mb-2">
                                ...
                                {event.is_league && (
                                    <span className="bg-blue-500/20 text-blue-400 border border-blue-500/30 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest">
                                        League
                                    </span>
                                )}
                                <span className="bg-white/5 border border-white/10 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-widest text-gray-300">
                                    {event.city}
                                </span>
                            </div>
                            <div className="mb-2">
