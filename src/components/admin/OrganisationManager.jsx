...
const OrganisationManager = ({ permissions, initialView = 'platform', onViewChange }) => {
    ...
    const AMENDMENT_ALLOWED_KEYS = [
        ...
        'allow_temporary_license', 'license_required_default', 'collect_tshirt_size', 'allow_tshirt_logo_upload', 'allow_tshirt_sponsor_name', 'player_gift_type', 'player_gift_types', 'entry_fee_notes',
