                                        {regStep === 1 ? (
                                            <div className="registration-step-1 space-y-5">
                                            ...
                                            <div className="registration-step-success flex-1 flex flex-col items-center justify-center py-16 px-8 text-center bg-[#0F172A] relative overflow-hidden">
                                                {/* Ambient Glows */}
